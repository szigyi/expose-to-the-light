...
import hu.szigyi.ettl.v1.influx.InfluxDomain.{CapturedDomain, ToCaptureDomain, ToSetSettingDomain}
import hu.szigyi.ettl.v1.service.CameraService.{CameraError, CapturedCameraModel, SettingsCameraModel}
